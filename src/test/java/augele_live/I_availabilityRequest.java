...
public class I_availabilityRequest {
	...
	@FindBy(xpath = "(//span[text()=\"Availability Request\"])[1]")private WebElement availabilityRequestModule;
	@FindBy(xpath = "(//span[text()=\"Availability Request\"])[2]")
	private WebElement availabilityReques;

	@FindBy(xpath = "//a[@href=\"https://augel-notfall-frontend.azurewebsites.net/admin/WeekendPlannings/add\"]")
	...
	@FindBy(xpath = "//input[@id=\"inputShift\"]")private WebElement ARSHift;
	...
	@FindBy(xpath = "//a[@href=\"https://augel-notfall-frontend.azurewebsites.net/admin/WeekendPlannings/history\"]")private WebElement availabilityRequestHistory;
	...
	@FindBy(xpath="//input[@value=\"76\"]")private WebElement swarget;
	
	
	
	@FindBy(xpath = "//input[@name=\"firefighter[76][4][is_ff]\"]")private WebElement nikhil;
	@FindBy(xpath = "//input[@name=\"firefighter[76][3][is_ff]\"]")private WebElement danrajS;
	
	@FindBy(xpath="//a[@href=\"https://augel-notfall-frontend.azurewebsites.net/admin/WeekendPlannings/list\"]")private WebElement list;
