...
public class m_ChatGroup {
		...
		@FindBy(xpath="//a[@href=\"https://augel-notfall-frontend.azurewebsites.net/admin/GroupChat/groupList\"]")private WebElement groupList;
		@FindBy(xpath="//a[@href=\"/admin/GroupChat/create\"]")private WebElement createNewChatGroup;
	    ...
	    @FindBy(xpath="//a[@href=\"https://augel-notfall-frontend.azurewebsites.net/admin/GroupChat/index\"]")private WebElement groupConversation ;
	...
	// @FindBy(xpath="")private WebElement ;
		...
		public void commonForCreateGroup(WebDriver driver) throws Throwable 
