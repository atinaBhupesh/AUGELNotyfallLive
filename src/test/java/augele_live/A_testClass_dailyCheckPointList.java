...
public class A_testClass_dailyCheckPointList extends B_baseClass {
	...
	String userName = "74-IN-Jonh-Jonh1-532";
	...
	public void lounchBrowser() throws Throwable {
		...
		Reporter.log("Hello, Daily check pointchecking process of AUGELNotfall has started.-"+date+">"+gCurrntTime, true);
	...
	public void createStormAlarm() throws Throwable {
		...
		public void extendStormAlarm() throws Throwable {	
